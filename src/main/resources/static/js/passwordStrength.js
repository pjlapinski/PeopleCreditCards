    ...
    var options = {
        ...
        setProgressBar = function ($el, score) {
            ...
            if (score < options.scores[0]) {
                progressbar.find(".progress-bar").addClass("bg-danger").removeClass("bg-warning").removeClass("bg-success");
                ...
                progressbar.find(".progress-bar").addClass("bg-warning").removeClass("bg-danger").removeClass("bg-success");
                ...
                progressbar.find(".progress-bar").addClass("bg-success").removeClass("bg-warning").removeClass("bg-danger");
